...
const handleLearnMoreClick = () => {
  currentSession.selectedTab.setUrl(
...
const SettingsHeaderText = () => {
  if (currentSession.updateAvailable) {
    return <div>Settings [version {version} -- Update Available]</div>;
  } else {
    return <div>Settings [version {version}]</div>;
  }
};
      ...
      <div style={pageStyle}>
        ...
        <Box1>
          ...
          <Box2>
            ...
            <Header1>Resolve domain via</Header1>
            <div>
              <OptionRow>
                <RadioButton
                  type="radio"
                  ...
                  value="1"
                  onChange={() => {
                    handleDomainLookupMethodChange(
                      DomainResolutionMethod.UnstoppableAPI
                    );
                  }}
                  checked={
                    settings.domainResolutionMethod ===
                    DomainResolutionMethod.UnstoppableAPI
                  }
                />
                <OptionLabel>Unstoppable.com API -</OptionLabel>{" "}
                <OptionLabel2> Non-paranoid + fast response times</OptionLabel2>
              </OptionRow>
              <OptionRow>
                <RadioButton
                  type="radio"
        ...
        <Box1>
          ...
          <Box2>
            ...
            <Header1>Download IPFS content via</Header1>
            <div>
              <OptionRow>
                <RadioButton
                  type="radio"
                  ...
                  value="1"
                  onChange={() => {
                    handleIPFSMethodChange(IPFSContentMethod.CloudflareCDN);
                  }}
                  checked={
                    settings.ipfsContentMethod ==
                    IPFSContentMethod.CloudflareCDN
                  }
                />
                <OptionLabel>Cloudlare CDN -</OptionLabel>{" "}
                <OptionLabel2> Non-paranoid + fast response times</OptionLabel2>
              </OptionRow>
              <OptionRow>
                <RadioButton
                  ...
                  value="2"
                  onChange={() => {
                    handleIPFSMethodChange(IPFSContentMethod.InfuraAPI);
                  }}
                  checked={
                    settings.ipfsContentMethod == IPFSContentMethod.InfuraAPI
                  }
                />
                <OptionLabel>Infura API -</OptionLabel>{" "}
                <OptionLabel2> Non-paranoid + fast response times</OptionLabel2>
              </OptionRow>
              <OptionRow>
                <RadioButton
                  ...
                  value="3"
                  onChange={() => {
                    handleIPFSMethodChange(
                      IPFSContentMethod.DesignatedIPFSNode
                    );
                  }}
                  checked={
                    settings.ipfsContentMethod ==
                ...
                />
                <OptionLabel>Directly from IPFS network -</OptionLabel>{" "}
                <OptionLabel2> Parnoid + slow response times</OptionLabel2>
              </OptionRow>
              {/* <Topic1>
              <div>
            ...
            <OptionRow>
              <OptionLabel2>
                <CheckBox
                  type="checkbox"
                  onChange={() => {
                    handleIPFSAlwaysRun(!settings.alwaysRunIPFS);
                  }}
                  checked={settings.alwaysRunIPFS}
                />
